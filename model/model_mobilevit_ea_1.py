...
class MobileViT(nn.Module):
    ...
    def __init__(self, model_cfg: Dict, num_classes: int = 1000):
        ...
        self.layer_6, out_channels = self._make_layer(input_channel=out_channels, cfg=model_cfg["layer5"])
        ...
        self.ea = External_attention(640)
        self.head = nn.Linear(640 * 4 * 4, 2048)
        self.hash_ea = nn.Sequential(
            nn.Dropout(),
            self.head,
        ...
        self.classifier.add_module(name="global_pool", module=nn.AdaptiveAvgPool2d(1))  # (128,640,7,7)->(128,640,1,1)
        self.classifier.add_module(name="flatten", module=nn.Flatten())  # (128,640)
